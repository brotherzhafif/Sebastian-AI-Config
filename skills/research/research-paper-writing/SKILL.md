...
## Sebastian Butler Integration

This skill is designed for the Sebastian Butler. It uses Hermes tools, delegation, scheduling, and memory for the full research lifecycle.
