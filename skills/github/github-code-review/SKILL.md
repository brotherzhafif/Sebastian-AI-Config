...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from Sebastian Butler\",
    \"comments\": [
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Sebastian Butler. Code looks clean — good test coverage, no security concerns."
